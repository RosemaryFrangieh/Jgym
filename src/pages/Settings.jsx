...
import { buildReceiptText, DEFAULT_RECEIPT_TEMPLATE } from '../utils/receiptPrinter'
...
// Sample data for the live receipt preview
const SAMPLE_MEMBER = {
  first_name: 'John',
  last_name: 'Doe',
...
export default function Settings() {
  ...
  // Live preview of the receipt using current form state
  const previewReceipt = useMemo(() => {
    return buildReceiptText(SAMPLE_MEMBER, SAMPLE_FAMILY, {
    ...
    <div className="min-h-screen bg-navy-950 text-slate-200">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 py-8 border-t border-navy-800 mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          {/* Sticky Preview Side */}
          {/* On large screens, this sticks to the top. When you scroll past the receipt form, it scrolls away naturally */}
          <div className="hidden lg:block lg:col-span-2">
            <div className="sticky top-24 space-y-4">
              ...
              {/* Realistic Receipt Paper Effect */}
              <div className="bg-slate-800 p-4 rounded-lg shadow-2xl border border-navy-700">
                <div className="bg-white text-gray-900 p-5 rounded-sm shadow-inner relative overflow-hidden">
                  {/* Dashed top border to mimic tear-off */}
...
{previewReceipt}
                  ...
                  {/* Dashed bottom border to mimic tear-off */}
                  <div className="absolute bottom-0 left-0 right-0 border-b-2 border-dashed border-gray-300"></div>
                </div>
              </div>
              
              <p className="text-xs text-slate-500 text-center px-4">
                Preview uses sample family data. Actual prints will use real member data and a physical thermal printer.
              </p>
            </div>
          </div>
