      ...
      <div className="bg-navy-800 rounded-xl w-full max-w-lg p-6 border border-navy-700 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {familyPhones.map((phone, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white placeholder:text-slate-600 focus:outline-none focus:border-electric-blue"
                      />
                      {familyPhones.length > 1 && (
                        <button type="button" onClick={() => setFamilyPhones(p => p.filter((_, idx) => idx !== i))} className="p-2 text-slate-400 hover:text-red-500" title="Remove">
                          <X size={18} />
                        </button>
                      )}
                    </div>
          ...
          <div>
            ...
            <select name="subscription_type" value={formData.subscription_type} onChange={handleChange} className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-electric-blue">
          ...
          {isCustom ? (
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input type="date" name="start_date" value={formData.start_date} onChange={handleChange} required className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-electric-blue" />
              </div>
              <div>
                <label className="block text-sm text-slate-400 mb-1">End Date</label>
                <input type="date" name="end_date" value={formData.end_date} onChange={handleChange} required className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-electric-blue" />
              </div>
              <div>
                <label className="block text-sm text-slate-400 mb-1">Custom Price ($)</label>
                <input type="number" name="base_price" value={formData.base_price} onChange={handleChange} required min="0" step="0.01" className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-electric-blue" />
              </div>
            </div>
          ) : (
            <div>
          ...
          {!isCustom && (
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input type="number" name="base_price" value={formData.base_price} onChange={handleChange} required disabled className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white disabled:opacity-50 focus:outline-none focus:border-electric-blue" />
              </div>
              <div>
                <label className="block text-sm text-slate-400 mb-1">Discount Type</label>
                <select name="discount_type" value={formData.discount_type} onChange={handleChange} className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-electric-blue">
              ...
              <div>
                ...
                <input type="number" name="discount_value" value={formData.discount_value} onChange={handleChange} disabled={formData.discount_type === 'none'} className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white disabled:opacity-50 focus:outline-none focus:border-electric-blue" />
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <textarea name="description" value={formData.description} onChange={handleChange} rows={3} placeholder="Any notes about this membership..." className="w-full bg-navy-900 border border-navy-700 rounded-lg px-3 py-2 text-white resize-none placeholder:text-slate-600 focus:outline-none focus:border-electric-blue" />
          </div>
